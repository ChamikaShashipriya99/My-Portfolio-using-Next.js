        ...
        <div className="fixed bottom-6 left-6 md:bottom-8 md:left-8 z-[90] font-sans">
            ...
            <AnimatePresence>
                {isOpen && (
                    ...
                    >
                        <GlassCard className="h-full flex flex-col p-0 overflow-hidden bg-black border-blue-500/20 shadow-[0_15px_40px_rgba(0,0,0,0.8)]">
                            {/* Panel Header */}
                            <div className="bg-black px-6 py-4 border-b border-white/10 flex items-center justify-between shrink-0">
                            ...
                            <form 
                                ...
                                className="p-4 border-t border-white/10 flex gap-2 items-center bg-black shrink-0"
                            >
                                <input
                                    ref={inputRef}
                                    type="text"
